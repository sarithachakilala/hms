...
line_no=710
	...
	pdf.draw_text "Package Name", :at => [10, line_no-5*difference], :size =>10
	...
	pdf.draw_text " #{@admission.package} ", :at => [150, line_no-5*difference], :size =>10 
	...
	pdf.draw_text "Package Category", :at => [370, line_no-5*difference] , :size =>10
	...
	pdf.draw_text " #{@admission.p_name} ", :at => [450, line_no-5*difference] , :size =>10 
	i=i+1
