...
pdf.draw_text "   Paid Amount", :at => [0, line_no-(k+9)*difference], :size =>10
	pdf.draw_text "   To wards consultation", :at => [0, line_no-(k+10)*difference], :size =>12
	...
	pdf.draw_text " #{@appointment_payment.paid_amount} ", :at => [150, line_no-(k+9)*difference], :size =>10 
	pdf.draw_text " #{@to_watds.capitalize}rupees only.", :at => [150, line_no-(k+10)*difference], :size =>12
